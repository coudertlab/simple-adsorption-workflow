...
def main():
    ...
    if args.command == "run": 
        ...
        output_isotherms_to_csv(args.output_dir,sim_dir_names)                                                     # 3.
    ...
    if args.command == "merge":
        merged_json = merge_json(args.output_dir,args.input_files)
        nb_isotherms = output_isotherms_to_json(args.output_dir,f'{args.output_dir}/run_merged.json',
